...
import { useUserHandlers } from './Store/state';
import UserList from './UserList';
import UserForm from './UserForm';
import SearchBar from './Store/search';
import SortButton from './Store/SortButton';
import Pagination from './Store/paginations';
...
const Admin: React.FC = () => {
  ...
  const { addUser, toggleLockUser, searchUsers, sortUsers } = useUserHandlers();
  ...
  const displayedUsers = filteredUsers.slice((currentPage - 1) * 10, currentPage * 10);
  useEffect(() => {
    ...
    <div className="app-container">
      ...
      <div className="app-content">
        <div className="app-sidebar">
          ...
          <Link to="/finance-management" className="app-sidebar-link">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
        ...
        <div className="projects-section">
          <SearchBar searchQuery={searchQuery} searchUsers={searchUsers} />
          <SortButton sortOrder={sortOrder} sortUsers={sortUsers} />
          <UserForm newUser={newUser} setNewUser={setNewUser} addUser={addUser} />
          <UserList users={displayedUsers} toggleLockUser={toggleLockUser} />
          <Pagination
